# Test a baseline CNN model on image simulated to represent different lighting conditions
...
plt.figure()
plt.plot(xvals, outputs[1], label='Original')
plt.xlabel("Frame #")
plt.xticks(xvals)
plt.ylabel("Control Output")
plt.ylim((-1,1))
